package asmaa.khb.mycomposeanimationapp.ui.theme
...
import asmaa.khb.mycomposeanimationapp.R
...
val Typography = Typography(
    h1 = TextStyle(
        fontFamily = AbrilFatface, fontWeight = FontWeight.Normal, fontSize = 30.sp
    ), h2 = TextStyle(
